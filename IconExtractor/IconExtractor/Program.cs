...
namespace IconExtractor
{
  ...
  class Program
  {
    ...
    private static bool useSize;
    private static int selectedSize;
    private static readonly String[] sizeArgs = new String[4] { "--size-16", "--size-32", "--size-48", "--size-256" };
    private static readonly int[] sizeSHIL = new int[4] { Shell32.SHIL_SMALL, Shell32.SHIL_LARGE, Shell32.SHIL_EXTRALARGE, Shell32.SHIL_JUMBO };
